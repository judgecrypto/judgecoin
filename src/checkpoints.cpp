...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 0,      hashGenesisBlock )
        ( 43700,  uint256("0xb748c3f20401d18f6455d51c5f775d6706f5aa427030368d38c599d6eb25d7b9"))
    ;
    ...
    // judgecoin: only descendant of current sync-checkpoint is allowed
    ...
    // judgecoin: reset synchronized checkpoint to last hardened checkpoint
...
// judgecoin: sync-checkpoint master key
...
// judgecoin: verify signature of sync-checkpoint message
...
// judgecoin: process synchronized checkpoint
